# 운영 가이드 (셀프호스트) — 기획서 9.4

RynL10n 셀프호스트 운영: 설치·업그레이드·백업/복구·재해 복구·에어갭·관측성.
라이선스: **Apache-2.0** (SDK·서버·어드민 전체 단일, 기능 게이팅 없음 — 9.2).
...
- 환경 변수: `RYNL10N_PORT` · `RYNL10N_DELIVERY_PORT` · `RYNL10N_DB` · `RYNL10N_STORAGE` · `RYNL10N_ADMIN_TOKEN`.
