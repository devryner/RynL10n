...
현재 `0.2.0`이 네 레지스트리에 모두 올라가 있습니다:

```
iOS      .package(url: "https://github.com/devryner/RynL10n", from: "0.2.0")   # SwiftPM (태그가 곧 배포)
Android  implementation("com.devryner.rynl10n:android:0.2.0")                  # Maven Central
