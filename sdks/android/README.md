...
dependencies {
    implementation("com.devryner.rynl10n:android:0.2.0")
}
```

> **Maven Central에 게시돼 있다 — `com.devryner.rynl10n:android:0.2.0`**(2026-09-17 · 4개 SDK
...
- **검증됨**: 코어 62개 테스트 통과 — 골든 벡터 정합 + 시나리오 A/B/C + **배포 플레인 HTTP 10개**
