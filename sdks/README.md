...
- 빌드·테스트: `cd sdks/ios && swift test` (51개: 골든 9 + 원격 배포 12 + 폴링·푸시·텔레메트리 10 + **로케일 축 5** + 시나리오 A/B/C·충돌 검사 4 + M4 5 + 변환 3 + bake 2 + 반응형 1).
...
- 빌드·테스트: `cd sdks/flutter && dart pub get && dart test` (54개: 골든 11 + 시나리오 5 + **앱 적용 경로 19** +
